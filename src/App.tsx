  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#121213] via-[#0e0e0f] to-[#080809] text-[#f3f4f6] relative flex flex-col justify-between selection:bg-red-500 selection:text-white antialiased overflow-x-clip">
      ...
      <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden">
        ...
        <div className="absolute top-[-10%] left-[-10%] w-[60vw] h-[60vw] rounded-full bg-red-900/10 blur-[150px]"></div>
        <div className="absolute bottom-[10%] right-[-10%] w-[50vw] h-[50vw] rounded-full bg-red-950/12 blur-[130px]"></div>
        <div className="absolute top-[35%] right-[10%] w-[45vw] h-[45vw] rounded-full bg-red-900/8 blur-[160px]"></div>
        <div className="absolute bottom-[-10%] left-[10%] w-[55vw] h-[55vw] rounded-full bg-red-950/10 blur-[140px]"></div>
